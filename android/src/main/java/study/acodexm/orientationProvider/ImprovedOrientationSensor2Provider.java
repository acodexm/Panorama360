package study.acodexm.orientationProvider;
...
public class ImprovedOrientationSensor2Provider extends OrientationProvider {
    ...
    private boolean isGyroscopeAvaiable = false;
     ...
     */
    public ImprovedOrientationSensor2Provider(ViewControl viewControl, SensorManager sensorManager) {
        super(sensorManager);
    ...
    public void onSensorChanged(SensorEvent event) {
        if (isGyroscopeAvaiable) {
            getRotationMatrix(matrix);
            mViewControl.rotateSphere(matrix);
            ...
            if (event.sensor.getType() == Sensor.TYPE_ROTATION_VECTOR) {
                ...
                mViewControl.rotateSphere(rotationMatrix);
            }
        }
    }
